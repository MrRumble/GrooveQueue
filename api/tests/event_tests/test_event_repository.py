...
def test_find_event_by_id(db_connection):
    ...
    expected_event = Event(
        ...
        band_id=1,
        max_requests_per_user=10,  # Added the new field
    ...
    assert result.max_requests_per_user == expected_event.max_requests_per_user  # Check new field
...
def test_find_all_events(db_connection):
    ...
    expected_events = [
        ...
        Event(
            ...
            band_id=3,
            max_requests_per_user=5,  # Added the new field
            created_at=None,
            updated_at=None
        ),
        Event(
            ...
            band_id=2,
            max_requests_per_user=7,  # Added the new field
            created_at=None,
            updated_at=None
        ),
        Event(
            ...
            band_id=1,
            max_requests_per_user=15,  # Added the new field
            created_at=None,
            updated_at=None
        ),
        Event(
            ...
            band_id=3,
            max_requests_per_user=3,  # Added the new field
            created_at=None,
            updated_at=None
        ),
    ]
...
def test_create_event(db_connection):
    ...
    found_event = event_repo.find(6)  # Assuming ID 6 is the new event
    ...
    assert found_event.max_requests_per_user == 5  # Check new field
...
def test_update_event(db_connection):
    ...
    event_to_update.max_requests_per_user = 10  # Update the new field
    ...
    assert updated_event.max_requests_per_user == 10
