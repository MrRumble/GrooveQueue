...
class EventRepository():
    ...
    def find(self, event_id):
        ...
        event = Event(
            ...
            band_id=row['band_id'],
            max_requests_per_user=row['max_requests_per_user'],  # Added this line
    ...
    def create(self, event):
        query = """
            INSERT INTO events (event_name, location, event_start, event_end, qr_code_content, band_id, max_requests_per_user, created_at, updated_at)
        ...
        params = (
            ...
            event.band_id,
            event.max_requests_per_user,  # Added this parameter
